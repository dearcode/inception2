...
public:
    ...
    */
    ...
    {
        flags |= LOG_EVENT_RELAY_LOG_F;
    }
    bool is_artificial_event() const
    {
        return flags & LOG_EVENT_ARTIFICIAL_F;
    }
    bool is_relay_log_event() const
    {
        return flags & LOG_EVENT_RELAY_LOG_F;
    }
    bool is_ignorable_event() const
    {
        return flags & LOG_EVENT_IGNORABLE_F;
    }
    bool is_no_filter_event() const
    {
        return flags & LOG_EVENT_NO_FILTER_F;
    }
...
public:
    ...
    */
    ...
    {
        return flags & LOG_EVENT_MTS_ISOLATE_F;
    }
...
{   LOAD_DUP_ERROR = 0, LOAD_DUP_IGNORE,
    LOAD_DUP_REPLACE
};
...
public:
    ...
    {
        return m_memory != NULL; /* we check malloc */
    }
...
public:
    ...
    */
    ...
    Log_event_type get_type_code()
    {
        return m_type;    /* Specific type (_V1 etc) */
    }
