...
static my_bool write_parameter(IO_CACHE *file, uchar *base, File_option *parameter)
{
...
my_bool sql_create_definition_file(const LEX_STRING *dir, const LEX_STRING *file_name,
...
static const char *parse_string(const char *ptr, const char *end, MEM_ROOT *mem_root,
                                LEX_STRING *str)
{
    // get string length
...
const char *parse_escaped_string(const char *ptr, const char *end, MEM_ROOT *mem_root,
                                 LEX_STRING *str)
{
    const char *eol = strchr(ptr, '\n');
...
my_bool File_parser::parse(uchar *base, MEM_ROOT *mem_root,
