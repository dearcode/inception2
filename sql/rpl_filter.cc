...
void Rpl_filter::add_db_rewrite(const char *from_db, const char *to_db)
{
...
/**
  ...
  @return
             ...
             1           error
*/
int Rpl_filter::build_table_hash_from_array(DYNAMIC_ARRAY *table_array, HASH *table_hash,
...
/**
  ...
  @return
             ...
             1           error
*/
int Rpl_filter::add_table_rule_to_hash(HASH *h, const char *table_spec, uint len)
{
...
int Rpl_filter::add_table_rule_to_array(DYNAMIC_ARRAY *a, const char *table_spec)
{
    const char *dot = strchr(table_spec, '.');
...
void Rpl_filter::add_do_db(const char *table_spec)
{
...
void Rpl_filter::add_ignore_db(const char *table_spec)
{
...
void Rpl_filter::init_table_rule_hash(HASH *h, bool *h_inited)
{
...
void Rpl_filter::init_table_rule_array(DYNAMIC_ARRAY *a, bool *a_inited)
{
...
TABLE_RULE_ENT *Rpl_filter::find_wild(DYNAMIC_ARRAY *a, const char *key, int len)
{
    uint i;
...
void Rpl_filter::free_string_array(DYNAMIC_ARRAY *a)
{
    uint i;
...
void Rpl_filter::table_rule_ent_hash_to_str(String *s, HASH *h, bool inited)
{
    s->length(0);
...
void Rpl_filter::table_rule_ent_dynamic_array_to_str(String *s, DYNAMIC_ARRAY *a,
        bool inited)
{
    s->length(0);
