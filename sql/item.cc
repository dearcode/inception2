...
type_conversion_status Item::save_str_value_in_field(Field *field, String *result)
{
    if (null_value)
...
type_conversion_status Item::save_in_field_no_warnings(Field *field, bool no_conversions)
{
...
{
    if (field == NULL || field->table == NULL)
        return 0;
...
type_conversion_status Item_param::save_in_field(Field *field, bool no_conversions)
{
    field->set_notnull();
...
type_conversion_status Item_copy_string::save_in_field(Field *field, bool no_conversions)
{
...
type_conversion_status Item_copy_int::save_in_field(Field *field, bool no_conversions)
{
...
type_conversion_status Item_copy_float::save_in_field(Field *field, bool no_conversions)
{
...
type_conversion_status Item_copy_decimal::save_in_field(Field *field, bool no_conversions)
{
    // TODO: call set_field_to_null_with_conversions below
    if (null_value)
        return set_field_to_null(field);
...
int Item_field::fix_outer_field(THD *thd, Field **from_field, Item **reference)
{
...
bool Item_field::fix_fields(THD *thd, Item **reference)
{
    ...
    if (!field) {				// If field is not checked
        /*
          ...
          of this Item_field
        */
        field_info = find_field_in_tables_object(thd, this,
                     context->first_name_resolution_table,
                     context->last_name_resolution_table,
                     reference,
        ...
        if (/*not existed*/field_info == NULL)
            return 0;

        set_field(field_info->field);
    }
...
type_conversion_status Item_field::save_in_field(Field *to, bool no_conversions)
{
...
type_conversion_status Item_null::save_in_field(Field *field, bool no_conversions)
{
    return set_field_to_null_with_conversions(field, no_conversions);
}
...
type_conversion_status Item_string::save_in_field(Field *field, bool no_conversions)
{
    String *result;
    result = val_str(&str_value);
...
type_conversion_status Item_uint::save_in_field(Field *field, bool no_conversions)
{
...
/**
  ...
  @retval !TYPE_OK  Warning/error as indicated by type_conversion_status enum
                    value
*/
type_conversion_status Item_int::save_in_field(Field *field, bool no_conversions)
{
...
type_conversion_status Item_temporal::save_in_field(Field *field, bool no_conversions)
{
...
type_conversion_status Item_decimal::save_in_field(Field *field, bool no_conversions)
{
    field->set_notnull();
    return field->store_decimal(&decimal_value);
}
...
type_conversion_status Item_float::save_in_field(Field *field, bool no_conversions)
{
    double nr = val_real();
...
type_conversion_status Item_hex_string::save_in_field(Field *field, bool no_conversions)
{
    field->set_notnull();
...
type_conversion_status Item_ref::save_in_field(Field *to, bool no_conversions)
{
    type_conversion_status res;
...
type_conversion_status Item_default_value::save_in_field(Field *field_arg, bool no_conversions)
{
    if (!arg) {
...
type_conversion_status Item_cache_str::save_in_field(Field *field, bool no_conversions)
{
