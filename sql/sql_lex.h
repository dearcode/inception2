...
public:
    ...
    */
    enum e_sql_cache
    { SQL_CACHE_UNSPECIFIED, SQL_NO_CACHE, SQL_CACHE };
...
public:
    ...
    */
    ...
    void exclude_level();
    void exclude_tree();
    inline select_result *get_result()
    {
        return result;
    }
...
public:
    ...
    */
    ...
    {
        return type_str[type(thd)];
    }
    static const char *get_type_str(type_enum type)
    {
