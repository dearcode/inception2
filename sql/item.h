...
static inline uint32 char_to_byte_length_safe(uint32 char_length_arg, uint32 mbmaxlen_arg)
{
...
public:
    ...
    enum cond_result
    { COND_UNDEF, COND_OK, COND_TRUE, COND_FALSE };
...
public:
    ...
    */
    ...
    virtual Item *copy_andor_structure(THD *thd)
    {
        return this;
    }
    ...
    */
    ...
    {
        return 0;    /* Needed for error checking */
    }
...
inline type_conversion_status Item_sp_variable::save_in_field(Field *field, bool no_conversions)
{
...
public:
    ...
    */
    ...
    bool is_splocal()
    {
        return 1;    /* Needed for error checking */
    }
...
public:
    ...
    inline enum_field_types field_type() const
    {
        return m_field_type;
    }
...
bool agg_item_charsets(DTCollation &c, const char *name,
                       Item **items, uint nitems, uint flags, int item_sep);
inline bool agg_item_charsets_for_string_result(DTCollation &c, const char *name,
...
inline bool agg_item_charsets_for_string_result_with_comparison(DTCollation &c,
        const char *name,
        Item **items, uint nitems,
        int item_sep = 1)
{
...
public:
    Item_num()
    {
        collation.set_numeric();    /* Remove gcc warning */
    }
...
private:
    virtual inline Settable_routine_parameter *get_settable_routine_parameter()
    {
        return this;
    }
