...
void Query_cache::insert(Query_cache_tls *query_cache_tls,
...
void Query_cache::abort(Query_cache_tls *query_cache_tls)
{
...
Query_cache_block *Query_cache::write_block_data(ulong data_len, uchar *data,
        ulong header_len,
...
void Query_cache::invalidate_table_internal(THD *thd, uchar *key, uint32 key_length)
{
...
void Query_cache::invalidate_query_block_list(THD *thd,
...
TABLE_COUNTER_TYPE Query_cache::register_tables_from_list(TABLE_LIST *tables_used,
...
my_bool Query_cache::insert_table(uint key_len, const char *key,
...
Query_cache_block *Query_cache::allocate_block(ulong len, my_bool not_less, ulong minimum)
{
...
Query_cache_block *Query_cache::join_free_blocks(Query_cache_block *first_block_arg,
...
void Query_cache::double_linked_list_simple_include(Query_cache_block *point,
        Query_cache_block **
        list_pointer)
{
...
TABLE_COUNTER_TYPE Query_cache::process_and_count_tables(THD *thd, TABLE_LIST *tables_used,
        uint8 *tables_type)
{
...
TABLE_COUNTER_TYPE Query_cache::is_cacheable(THD *thd, size_t query_len, const char *query,
        LEX *lex,
...
my_bool Query_cache::check_integrity(bool locked)
{
    ...
    do {
        ...
        } else if (((uchar *)block) + block->length != ((uchar *)block->pnext)) {
            DBUG_PRINT("error",
