...
*/
static void adjust_time_range_with_warn(MYSQL_TIME *ltime, uint8 decimals)
{
...
type_conversion_status Item_temporal_hybrid_func::save_in_field(Field *field, bool no_conversions)
{
...
type_conversion_status Item_func_now::save_in_field(Field *to, bool no_conversions)
{
    to->set_notnull();
...
longlong Item_extract::val_int()
{
    ...
    case INTERVAL_HOUR_SECOND:
        return (long) (ltime.hour * 10000 + ltime.minute * 100 +
                       ltime.second) * neg;
