...
{
    int		id;
    int		select_type;/*st_select_lex::SLT_DERIVED*/
    char	table[NAME_CHAR_LEN];
    /*
...
typedef struct explain_info_struct explain_info_t;
struct explain_info_struct
{
    LIST_BASE_NODE_T(select_info_t) field_lst;
};
...
enum release_type
{ RELEASE_NORMAL, RELEASE_WAIT_FOR_DROP };
...
public:
    ...
    */
    ...
    int          updatable;		/* VIEW/TABLE can be updated now */
    ...
    */
    ...
    {
        return view != NULL ? view_db.str : db;
    }
...
int mysql_prepare_create_table(THD *thd, HA_CREATE_INFO *create_info,
