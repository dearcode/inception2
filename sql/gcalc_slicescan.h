...
public:
    ...
    public:
        ...
        inline Info *get_next()
        {
            return (Info *)next;
        }
        inline const Info *get_next() const
        {
            return (const Info *)next;
        }
#ifndef DBUG_OFF
    ...
    const Info *get_first() const
    {
        return (const Info *)m_first;
    }
    Gcalc_dyn_list::Item **get_last_hook()
    {
        return m_hook;
    }
    void reset();
...
public:
    ...
    public:
        ...
        inline const point *get_next() const
        {
            return (const point *)next;
        }
...
public:
    ...
    inline Gcalc_heap::Info *more_points()
    {
        return m_cur_pi;
    }
    ...
    inline Gcalc_scan_events get_event() const
    {
        return m_event0;
    }
    ...
    inline const point *get_b_slice() const
    {
        return m_slice0;
    }
    inline const point *get_t_slice() const
    {
        return m_slice1;
    }
...
public:
    ...
    inline const Gcalc_heap::Info *get_pi() const
    {
        return sp->pi;
    }
    inline gcalc_shape_info get_shape() const
    {
        return sp->get_shape();
    }
