...
#define INC_ERROR_NONE_STAGE          0
#define INC_ERROR_CHECK_STAGE         1
#define INC_ERROR_EXECUTE_STAGE       2
#define INC_ERROR_BACKUP_STAGE        3

#define INC_NONE_STAGE                0
#define INC_CHECK_STAGE               1
#define INC_EXECUTE_STAGE             2

#define MYSQLDDL                        1
#define MYSQLDML                        2

#define INCEPTION_COMMIT        "inception_magic_commit"
...
struct source_info_space_struct
{
...
typedef struct tablecache_struct tablecache_t;
struct tablecache_struct
{
    LIST_BASE_NODE_T(table_info_t) tablecache_lst;
};

typedef struct dbinfo_struct dbinfo_t;
...
typedef struct dbcache_struct dbcache_t;
struct dbcache_struct
{
    LIST_BASE_NODE_T(dbinfo_t) dbcache_lst;
};


typedef struct sql_cache_struct sql_cache_t;
struct sql_cache_struct
{
    LIST_BASE_NODE_T(sql_cache_node_t) field_lst;
    int            seqno_cache;
};

typedef struct split_table_struct split_table_t;
...
typedef struct split_cache_node_struct split_cache_node_t;
...
typedef struct split_cache_struct split_cache_t;
struct split_cache_struct
{
...
extern mysql_mutex_t isql_option_mutex;
...
*/
inline CHARSET_INFO *mysqld_collation_get_by_name(const char *name,
...
public:
    ...
    */
    ...
    const CHARSET_INFO *query_charset() const
    {
...
{
#ifndef DBUG_OFF
    friend const char *ha_list_names(Ha_trx_info *ha_list, char *const buf_arg)
    {
        char *buf = buf_arg;
...
*/
static inline void my_micro_time_to_timeval(ulonglong micro_time, struct timeval *tm)
{
...
public:
    ...
    */
    void clear_binlog_accessed_db_names()
    {
...
public:
    ...
    */
    ...
    MYSQL *mysql;
    str_t        *errmsg;
    int           err_level;//÷ª”–»˝÷÷º∂±£¨0£∫√ª”–¥ÌŒÛ 1£∫√ª”–“¿’’dba∂®“ÂπÊ‘Ú 2£∫÷¬√¸¥ÌŒÛ
    dbcache_t dbcache;
    str_t        ddl_rollback;
    str_t        setnames;
    str_t        usedb;
...
public:
    ...
    */
    ...
    inline void enter_cond(mysql_cond_t *cond, mysql_mutex_t *mutex,
...
public:
    ...
    */
    ...
    virtual bool initialize_tables (JOIN *join = 0)
    {
        return 0;
    }
...
public:
    ...
    const THD *get_thd(void)
    {
        return thd;
    }
    const HA_CREATE_INFO *get_create_info()
    {
        return create_info;
    };
    int prepare2(void);
