...
public:
    ...
    */
    ...
    inline ulonglong get_group_master_log_pos()
    {
    ...
    inline ulonglong get_group_relay_log_pos()
    {
    ...
    inline ulonglong get_event_relay_log_pos()
    {
...
#if MYSQL_VERSION_ID < 40100
    inline ulonglong get_future_master_log_pos()
    {
        return future_master_log_pos;
    }
#else
    inline ulonglong get_future_group_master_log_pos()
    {
