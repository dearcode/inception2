...
static inline my_bool my_win_is_console_cached(FILE *file)
{
...
my_bool get_one_option(int optid, const struct my_option *opt __attribute__((unused)),
                       char *argument)
{
    switch(optid) {
...
static int com_tee(String *buffer __attribute__((unused)),
                   char *line __attribute__((unused)))
{
...
#ifdef USE_POPEN
static int com_pager(String *buffer __attribute__((unused)),
                     char *line __attribute__((unused)))
{
...
#ifdef USE_POPEN
static int com_shell(String *buffer __attribute__((unused)),
                     char *line __attribute__((unused)))
{
    char *shell_cmd;
